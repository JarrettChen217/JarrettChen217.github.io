...
function detailSections(p){
 const sections={
  video:()=>featuredVideo(p),background:()=>`<div class="detail-section"><h3>${label('Background','项目背景')}</h3><p>${esc(t(p.background))}</p></div>`,
 ...
 const order=p.sectionOrder||['background','contributions','product','demo','journey','architecture','engineering','team','resources','scope'];
